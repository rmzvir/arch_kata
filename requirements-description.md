...
- Сценарии администратора системы:
...
| *Мероприятие*              | - создание/обновление мероприятия<br>- голосования за следующий трек<br>- оценка трека/исполнителя<br>- голосования за следующего исполнителя                                                            | эластичность, надежность, производительность, наблюдаемость                           |  
...
- Для реализация требований доступности и эластичности, следует рассмотреть использование стиля микросервисов с асинхронной семантикой передачи сообщений.
