...
| *Радиостанция (технические администраторы* | - быстрое и простое развертывание<br> -динамическая устойчивость к нагрузке<br>                                                                                                                                                                                                                 | модифицируемость, бесперебойность, доступность                                     |
...
| *Бизнес-партнеры*                          | - корректность статистических данных                                                                                                                                                                                                                                                            | Архивируемость                                                                              |  
...
| *Аналитика данных*         | - компании партнеры	<br>- сотрудники радиостанции                                                                                                                                                         | Целостность, производительность, конфигурируемость,, авторизуемость, аутентифицируемость |                       
